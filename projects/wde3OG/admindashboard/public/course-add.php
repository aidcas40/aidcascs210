...
require __DIR__ . '/../src/inc/course-add.php';
require_login();
?>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" name="crs_code" id="crs_code" value="<?= $inputs['crs_code'] ?? '' ?>" 
                      class="form-control <?= error_class($errors, 'crs_code') ?>">
                <small><?= $errors['crs_code'] ?? '' ?></small>
            </div>
